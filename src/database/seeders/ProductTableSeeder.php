...
class ProductTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => 'images/kiwi.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => 'images/strawberry.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => 'images/orange.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => 'images/watermelon.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => 'images/peach.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => 'images/muscat.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => 'images/pineapple.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => 'images/grapes.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => 'images/banana.png',  // `storage/app/public/images/banana.png
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => 'images/melon.png',  // `storage/app/public/images/banana.png
